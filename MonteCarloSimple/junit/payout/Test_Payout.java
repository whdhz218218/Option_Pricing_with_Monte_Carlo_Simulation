...
public class Test_Payout  extends TestCase {
	...
	public void testcall() {
		...
		PayoutCall poCall=new PayoutCall(K,date);
		assertEquals(poCall.payout(_path),1.0);
		
		String date2="2019-09-01";
		PayoutCall poCall2=new PayoutCall(K,date2);
		assertEquals(poCall2.payout(_path),0.0);
		
		String date3="2019-01-01";
		PayoutCall poCall3=new PayoutCall(K,date3);
		assertEquals(poCall3.payout(_path),6.0);
	}
